...
export const CONFIG_PATH = path.join(__dirname, "configs.json");
export const SONG_DATA_SEPARATOR = "._-_.";
export const SUNO_BASE_API_URL = "https://studio-api.prod.suno.com/api";
